...
router.post("/", validateDto(CreateGroupStandingDto), asyncHandler(controller.create));
router.put("/:id", validateDto(UpdateGroupStandingDto), asyncHandler(controller.update));
