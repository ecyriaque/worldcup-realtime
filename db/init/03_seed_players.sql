...
((SELECT team_id FROM team WHERE code='RSA'), 'Percy', 'Tau', 11, 'FORWARD', '1994-05-13', 'South Africa'),
((SELECT team_id FROM team WHERE code='RSA'), 'Themba', 'Zwane', 10, 'MIDFIELDER', '1989-08-03', 'South Africa'),
((SELECT team_id FROM team WHERE code='RSA'), 'Ronwen', 'Williams', 1, 'GOALKEEPER', '1992-01-21', 'South Africa'),
...
((SELECT team_id FROM team WHERE code='HAI'), 'Duckens', 'Nazon', 11, 'FORWARD', '1994-04-07', 'Haiti'),
((SELECT team_id FROM team WHERE code='HAI'), 'Stéphane', 'Lambese', 1, 'GOALKEEPER', '1993-01-03', 'Haiti'),
((SELECT team_id FROM team WHERE code='HAI'), 'Derrick', 'Etienne', 20, 'MIDFIELDER', '1996-12-20', 'Haiti'),
